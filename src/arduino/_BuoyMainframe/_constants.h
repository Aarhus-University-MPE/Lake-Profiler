...
#define ModuleToString(m) \
  ((m) == 0 ? "Primary Power" : ((m) == 1 ? "Motor Power" : ((m) == 2 ? "Canister Power" : ((m) == 3 ? "Motor" : ((m) == 4 ? "SD reader" : ((m) == 5 ? "Realtime Clock" : ((m) == 6 ? "NA2" : ((m) == 7 ? "NA3" : ((m) == 8 ? "NA4" : ((m) == 9 ? "NA5" : ((m) == 10 ? "Long Range Communication (LORA)" : ((m) == 11 ? "Canister Communication" : ((m) == 12 ? "Debug Communication" : ((m) == 13 ? "Blackbox" : ((m) == 14 ? "Canister Heartbeat" : ((m) == 15 ? "Reserved" : "Unknown"))))))))))))))))
